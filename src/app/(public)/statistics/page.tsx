...
import { getScoreTrends, getCourseBreakdowns, getLeagueYearlyAverages, getTopRoundsAllTime } from "@/lib/stats";
...
export default async function StatisticsPage({
  ...
  const [trends, courseBreakdowns, yearlyAverages, allTimeTopRounds] = await Promise.all([
    getScoreTrends(season),
    getCourseBreakdowns(season),
    getLeagueYearlyAverages(),
    getTopRoundsAllTime(5),
  ]);
